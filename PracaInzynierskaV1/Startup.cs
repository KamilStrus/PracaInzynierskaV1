...
namespace PracaInzynierskaV1
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseCors(options => options.WithOrigins("http://localhost:3000").AllowAnyHeader().AllowAnyMethod()); // https://www.fiwus.com tu zmiana z localhosta posz³a http://localhost:3000
