...
namespace PracaInzynierskaV1
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseCors(options => options.WithOrigins("https://www.fiwus.com").AllowAnyHeader().AllowAnyMethod()); // https://www.fiwus.com tu zmiana z localhosta posz³a http://localhost:3000
